...
/***/ 60:
/*!*************************************************************************!*\
  !*** D:/hbuild-item/market_wx/main.js?{"page":"pages%2Findex%2Findex"} ***!
  \*************************************************************************/
...
/***/ 61:
/*!******************************************************!*\
  !*** D:/hbuild-item/market_wx/pages/index/index.vue ***!
  \******************************************************/
/*! no static exports found */
...
/***/ 62:
/*!*************************************************************************************************!*\
  !*** D:/hbuild-item/market_wx/pages/index/index.vue?vue&type=template&id=57280228&scoped=true& ***!
  \*************************************************************************************************/
...
try {
  components = {
    uSwiper: function() {
      return __webpack_require__.e(/*! import() | node-modules/uview-ui/components/u-swiper/u-swiper */ "node-modules/uview-ui/components/u-swiper/u-swiper").then(__webpack_require__.bind(null, /*! uview-ui/components/u-swiper/u-swiper.vue */ 525))
    },
    uImage: function() {
    ...
    uMask: function() {
      return __webpack_require__.e(/*! import() | node-modules/uview-ui/components/u-mask/u-mask */ "node-modules/uview-ui/components/u-mask/u-mask").then(__webpack_require__.bind(null, /*! uview-ui/components/u-mask/u-mask.vue */ 574))
    },
    uPopup: function() {
...
var render = function() {
  ...
  var l8 = _vm.optData.options
    ? _vm.__map(_vm.optData.options, function(item, i) {
        var $orig = _vm.__get_orig(item)

        var l0 =
          item.type == "productTabs" &&
          item.tabs &&
          item.tabs.length > 0 &&
          item.style == "1" &&
          item.col_type == "1"
            ? _vm.__map(item.tabs[_vm.current].data, function(ele, index) {
                var $orig = _vm.__get_orig(ele)

                var f0 = _vm._f("isTalk")(ele.price)

                var a0 = {
                  background: item.buy_btn_color
                }
                return {
                  $orig: $orig,
                  f0: f0,
        ...
        var l1 =
          ...
          item.col_type == "2"
            ? _vm.__map(item.tabs[_vm.current].data, function(ele, index) {
                ...
                var f1 = _vm._f("isTalk")(ele.price)
        ...
        var l2 =
          ...
          item.style == "2"
            ? _vm.__map(item.tabs[_vm.current].data, function(ele, index) {
                ...
                var f2 = _vm._f("isTalk")(ele.price)
            ...
            : null
        var l3 =
          item.type == "productDiy" &&
          item.data &&
          item.data.length > 0 &&
          item.style == "1" &&
          item.col_type == "1"
            ? _vm.__map(item.data, function(ele, index) {
                var $orig = _vm.__get_orig(ele)

                var f3 = _vm._f("isTalk")(ele.price)
        ...
        var l4 =
          ...
          item.col_type == "2"
            ? _vm.__map(item.data, function(ele, index) {
                ...
                var f4 = _vm._f("isTalk")(ele.price)
        ...
        var l5 =
          ...
          item.style == "2"
            ? _vm.__map(item.data, function(ele, index) {
                ...
                var f5 = _vm._f("isTalk")(ele.price)
        ...
        var a6 =
          item.type == "search"
            ...
            : null
        var l7 =
          item.type == "shopDiy" && item.data && item.data.length > 0
            ? _vm.__map(item.data, function(ele, index) {
                var $orig = _vm.__get_orig(ele)

                var l6 = _vm.__map(ele.data, function(prod, __i0__) {
                  var $orig = _vm.__get_orig(prod)

                  var f6 = _vm._f("isTalk")(prod.price)
    ...
    : null
  var l9 = _vm.optData.alertAd
    ? _vm.optData.alertAd.data.filter(function(ele) {
        return !ele.show
      })
    : null
  ...
  if (!_vm._isMounted) {
    _vm.e0 = function($event, index) {
      ...
      return _vm.handleClosePopup(index)
    }
    ...
    _vm.e1 = function($event, item) {
      ...
      return _vm.__set_model(item, "popupShow", $event, [])
    }
    ...
    _vm.e2 = function($event, item) {
      ...
      return _vm.handleGoto(item.link)
    }
  }
...
/***/ 64:
/*!*******************************************************************************!*\
  !*** D:/hbuild-item/market_wx/pages/index/index.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var _default =
{
  ...
  onShareTimeline: function onShareTimeline() {
    return {
      ...
      query: "login=".concat(uni.getStorageSync('login')),
  ...
  onLoad: function onLoad(options) {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
              // console.log(options)
              options.memu_id ? _this.memu_id = options.memu_id : 1;
              options.login ? uni.setStorageSync('sharelogin', options.login) : {};_context.next = 4;return (
                _this.homeUrl());case 4:

              _this.checkAlertAd();
              _this.initBtnsData();case 6:case "end":return _context.stop();}}}, _callee);}))();
  },
  ...
  computed: {
    maskFlag: function maskFlag() {
      if (!this.optData.alertAd) return false;
      return this.optData.alertAd.data.some(function (ele) {return ele.popupShow && !ele.show;});
    } },

  methods: {
    homeUrl: function homeUrl() {var _this2 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {var res;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:_context2.next = 2;return (
                  _this2.$http.get('/Market/home'));case 2:res = _context2.sent;
                if (res.data.code == 1) {
                  _this2.optData = res.data.list;
                  _this2.share_title = res.data.share_title;
                  _this2.share_img = res.data.share_img;
                  ...
                  uni.setNavigationBarTitle({
                    title: _this2.optData.name });

                  uni.setNavigationBarColor({
                    frontColor: _this2.optData.nav_bar_color,
                    backgroundColor: _this2.optData.nav_bar_bgcolor,
                    animation: {
                      duration: 400,
                      timingFunc: 'easeIn' } });
    ...
    handleClickServiceIcon: function handleClickServiceIcon() {
      uni.showToast({
        title: '功能暂未开通',
        icon: 'none' });

    },
    handleProdDetail: function handleProdDetail(obj) {
      this.handleGoto("/pages/prodDetail/prodDetail?id=".concat(obj.id));
    },
    handleShopDetail: function handleShopDetail(obj) {
      this.handleGoto("/pages/shop/shop?id=".concat(obj.id));
    },
    handleCouponBtn: function handleCouponBtn(obj) {
      uni.showToast({
        title: '功能暂未开通',
        icon: 'none' });

    },
    handleProductBuyBtn: function handleProductBuyBtn(obj) {var _this3 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee3() {var res;return _regenerator.default.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:
                uni.showLoading();
                console.log(obj);_context3.next = 4;return (
                  _this3.$http.get('/Market/api.html?api_url_xcx=productDetail_json', {
                    params: {
                      id: obj.id } }));case 4:res = _context3.sent;



                if (res.data.code == 1) {
                  _this3.$store.dispatch('addCart', res.data.list);
                }

                // handleProductBuyBtn(obj)
              case 6:case "end":return _context3.stop();}}}, _callee3);}))();},
    handleSearch: function handleSearch(value) {
      this.handleGoto("/pages/prodList/prodList?term=".concat(value));
    },
    handleNewsClick: function handleNewsClick(obj) {
      this.handleGoto("/pages/news/newsDetail?type=news&id=".concat(obj.id));
    },
    ...
    handleChangeTabsIndex: function handleChangeTabsIndex(index) {
      this.current = index;
    },
    handleChangeNewsIndex: function handleChangeNewsIndex(index) {
      this.currentNews = index;
    },
    handleChangeHqIndex: function handleChangeHqIndex(index) {
      this.currentHq = index;
    },
    handleClickIcon: function handleClickIcon(obj) {
      if (obj.type == 2) {//跳转类型
        this.handleGoto(obj.type_link);
      } else if (obj.type == 1) {//弹窗类型
        this.btnAlertList.forEach(function (ele) {
    ...
    handleSwiperClick: function handleSwiperClick(obj) {
      this.handleGoto(obj.link);
    },
    handleGoto: function handleGoto(link) {
      if (!link) return;
      uni.navigateTo({
        url: link });

    },
    initBtnsData: function initBtnsData() {var _this4 = this;
      this.btnAlertList = this.optData.btns.data.filter(function (ele) {return ele.type == 1;});
      this.btnAlertList.forEach(function (ele, index) {
        _this4.$set(_this4.btnAlertList[index], 'popupShow', false);
      });
    },
    checkAlertAd: function checkAlertAd() {var _this5 = this;
      var alertAd_old = uni.getStorageSync('alertAd');
      var alertAd = this.optData.alertAd.data;
      alertAd.reverse();
      if (alertAd.length == 0) return;
      var alertAd_new = [];
      if (!alertAd_old) {
        alertAd.forEach(function (ele, index) {
          _this5.$set(_this5.optData.alertAd.data[index], 'popupShow', true);
          // if(index == 0) {
          // ele.popupShow = true
          // }else {
          // 	ele.popupShow = false
        ...
        alertAd_new = alertAd.filter(function (ele) {return ele.show_type == '1';});
      } else {
        alertAd_new = alertAd_old;
        alertAd.forEach(function (ele, index) {
          if (ele.show_type == "1") {
            var flag = alertAd_old.some(function (item) {
        ...
        alertAd_new = [].concat(_toConsumableArray(alertAd_new), _toConsumableArray(alertAd.filter(function (ele) {return ele.show === false;})));
      }
      uni.setStorageSync('alertAd', alertAd_new);
    },
    handleClosePopup2: function handleClosePopup2(index) {
      this.btnAlertList[index].popupShow = false;
    },
    handleClosePopup: function handleClosePopup(index) {
...
/***/ 66:
/*!****************************************************************************************************************!*\
  !*** D:/hbuild-item/market_wx/pages/index/index.vue?vue&type=style&index=0&id=57280228&lang=scss&scoped=true& ***!
  \****************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
